...
def generate_launch_description():
    launch_file_dir = os.path.join(get_package_share_directory('turtlebot_odom'), 'launch')
    ...
    odometry_cmd = Node(
        package='turtlebot_odom',
        executable='turtlebot_odom_node',
    ...
    controller_cmd = Node(
        ...
        namespace=robot_namespace,
        parameters=[
            os.path.join(get_package_share_directory('turtlebot_waypoint_controller'), 'param', 'waypoints.yaml'),
            {'bypass_start': True}
        ],
        output='screen'
    )
    ...
    # Uncomment client for headless mode
